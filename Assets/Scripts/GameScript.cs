...
public class GameScript : MonoBehaviour {
	...
	public int sectionCount, scoreInt = 0, spawnIndex, lifepoints = 3, scoreUiscoreInt = 0, reward = 0;
	...
	public bool fpsCounterStatus = false, subtitlesOn = false, controlGame = true, introOn = false, controlScore = false, gameoff = false, scoreoff = false, coinDestroyed = false, zerolife = true, clickControl = true, coinSpawned = false, thanksoff = false;
	public Transform[] spawnPoints;
	public string[] thanksTexts;
	float deltaTime = 0.0f;
	public string[] Numbers = new string[3] {"1","2","3"};
